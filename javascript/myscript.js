...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= " Heart Rate From That Someone " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;My heartbeat is like that because:';
document.querySelector('.Description .modal-body').innerHTML = 'Anh đang nhớ em đó , Anh biết lỗi rồi vợ ơi <i class="fas fa-heart"></i> ';
